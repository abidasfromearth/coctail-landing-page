...
const About = () => {
  useGSAP(() => {
    const splitedText = SplitText.create('#about h2', {
      type: 'words',
    });
      ...
      <div className="mb-16 px-5 md:px-0">
        <div className="content">
          ...
          <div className="sub-content">
            <p>
              Every cocktail we serve is a reflection of our obsession with detail — from the first muddle to the final garnish. That care
